...
export default function Waterworks({navigation, route}) {
    // constructor(porps) {
    //     super(props)
        ...
        return (
            <View style= {[{alignItems:'center'}]}>
                <View style = {styles.BG}>
                    <Text style={styles.textset}> คำนวณค่าน้ำ </Text>
                </View>
                <View>
                    <TextInput
                        style={styles.textIn1}
                        placeholder="กรอกเลขมิเตอร์น้ำ (เดือนที่แล้ว)"
                        onChangeText={(count1) => setCount1(count1)}
                    />
                    <TextInput
                        style={styles.textIn2}
                        placeholder="กรอกเลขมิเตอร์น้ำ (เดือนนี้)"
